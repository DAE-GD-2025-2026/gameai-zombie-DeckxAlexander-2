...
#include "BTT_FleeFromZombieDeckxAlexander.h"
...
UBTT_FleeFromZombieDeckxAlexander::UBTT_FleeFromZombieDeckxAlexander()
{
	bNotifyTick = true;
}

EBTNodeResult::Type UBTT_FleeFromZombieDeckxAlexander::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
AActor* UBTT_FleeFromZombieDeckxAlexander::GetClosestZombie(TArray<AActor*> zombies)
{
...
FVector UBTT_FleeFromZombieDeckxAlexander::CalculateDesiredVelocity()
{
