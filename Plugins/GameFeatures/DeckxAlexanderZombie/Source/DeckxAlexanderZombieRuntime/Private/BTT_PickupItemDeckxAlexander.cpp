...
#include "BTT_PickupItemDeckxAlexander.h"
...
UBTT_PickupItemDeckxAlexander::UBTT_PickupItemDeckxAlexander()
{
}

EBTNodeResult::Type UBTT_PickupItemDeckxAlexander::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
bool UBTT_PickupItemDeckxAlexander::IsInventoryFull(UInventoryComponent* inventory)
{
...
void UBTT_PickupItemDeckxAlexander::CheckItems(UInventoryComponent* inventory, UBlackboardComponent* bb)
{
	bool hasFood = false;
...
int UBTT_PickupItemDeckxAlexander::CheckPriorityThrowSlot(UInventoryComponent* inventory, UBlackboardComponent* bb)
{
	int medkitAmount{};
	int foodAmount{};
	int pistolAmount{};
