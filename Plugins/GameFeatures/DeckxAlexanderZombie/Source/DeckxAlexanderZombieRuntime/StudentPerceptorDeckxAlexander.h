...
#include "StudentPerceptorDeckxAlexander.generated.h"

UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class DECKXALEXANDERZOMBIERUNTIME_API UStudentPerceptorDeckxAlexander : public UActorComponent
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UStudentPerceptorDeckxAlexander();
